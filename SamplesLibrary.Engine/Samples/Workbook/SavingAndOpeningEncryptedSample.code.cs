...
namespace SamplesLibrary.Engine.Samples.Workbook
{
    public class SavingAndOpeningEncryptedSample : ISpreadsheetGearEngineSample
    {
        ...
        public void RunSample()
        {
            ...
            string outputFolderPath = Helpers.GetFullOutputFolderPath(@"Temp\EncryptedWorkbook.xlsx");
            ...
            Workbook.SaveAs(outputFolderPath, SpreadsheetGear.FileFormat.OpenXMLWorkbook, "MyPassword");
            ...
            using (SpreadsheetGear.IWorkbookSet workbookSet = SpreadsheetGear.Factory.GetWorkbookSet())
            {
                ...
                workbookSet.Workbooks.Open(outputFolderPath, "MyPassword");
