...
// https://www.spreadsheetgear.com/Support/Samples/API/ChartingStockVOHLC
namespace SamplesLibrary.Engine.Samples.Charting.Stock
{
    public class VOHLCStockChartSample : ISpreadsheetGearEngineSample
    {
        ...
        public void InitializeWorkbook()
        {
            ...
            string workbookPath = Helpers.GetFullOutputFolderPath(@"Files\Engine\ChartData-Stock-V-O-H-L-C.xlsx");
        ...
        public void RunSample()
        {
            ...
            // Set the chart type to a volume-high-low-close stock chart.
            chart.ChartType = SpreadsheetGear.Charts.ChartType.StockVHLC;

            // Get a reference to the first chart group used for the volume series.
            ...
            chart.HasTitle = true;
            chart.ChartTitle.Text = "ABC Company (Volume-High-Low-Close)";
