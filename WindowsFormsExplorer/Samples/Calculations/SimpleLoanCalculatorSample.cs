namespace WindowsFormsExplorer.Samples.Calculations
{
    public partial class SimpleLoanCalculatorSample : SampleUserControl
    {
        ...
        public SamplesLibrary.Windows.Samples.Calculations.SimpleLoanCalculatorSample Sample { get; private set; }

        private void Calculate()
        {
            SamplesLibrary.Windows.Samples.Calculations.SimpleLoanCalculatorResults results =
        ...
        {
            Sample = new SamplesLibrary.Windows.Samples.Calculations.SimpleLoanCalculatorSample();
        }
        #endregion
    }
}
