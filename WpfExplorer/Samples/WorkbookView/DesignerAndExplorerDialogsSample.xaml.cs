...
namespace WPFExplorer.Samples.WorkbookView
{
    public partial class DesignerAndExplorerDialogsSample : SampleUserControl
    {
        ...
        public SamplesLibrary.Windows.Samples.WorkbookView.DesignerAndExplorerDialogsSample Sample { get; private set; }
        ...
        {
            Sample = new SamplesLibrary.Windows.Samples.WorkbookView.DesignerAndExplorerDialogsSample();
