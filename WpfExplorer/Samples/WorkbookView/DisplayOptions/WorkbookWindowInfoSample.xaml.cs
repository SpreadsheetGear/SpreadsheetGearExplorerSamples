...
namespace WPFExplorer.Samples.WorkbookView.DisplayOptions
{
    public partial class WorkbookWindowInfoSample : SampleUserControl
    {
        ...
        public SamplesLibrary.Windows.Samples.WorkbookView.DisplayOptions.WorkbookWindowInfoSample Sample { get; private set; }
        ...
        {
            Sample = new SamplesLibrary.Windows.Samples.WorkbookView.DisplayOptions.WorkbookWindowInfoSample();
