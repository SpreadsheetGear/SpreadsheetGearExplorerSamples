namespace SharedSamples.Samples.Charting.Stock
{
    public class OHLCStockChartSample : SharedEngineSample
    {
        public override void PreLoadWorkbook()
        {
            // Get the full path to a workbook with some data for the chart.
            string workbookPath = Helpers.GetFullOutputFolderPath(@"Files\Engine\ChartData-Stock-O-H-L-C.xlsx");
        ...
        public override void RunSample()
        {
            ...
            SpreadsheetGear.IRange source = cells["G2:K24"];
            ...
            // Set the chart type to an open-high-low-close stock chart.
            chart.ChartType = SpreadsheetGear.Charts.ChartType.StockOHLC;

            // Get a reference to the first and only chart group.
            SpreadsheetGear.Charts.IChartGroup chartGroup = chart.ChartGroups[0];

            // Change the fill color of the down bars.
            chartGroup.DownBars.Format.Fill.ForeColor.RGB = SpreadsheetGear.Colors.Red;

            // Change the fill color of the up bars.
            chartGroup.UpBars.Format.Fill.ForeColor.RGB = SpreadsheetGear.Colors.Green;
            ...
            chart.HasTitle = true;
            chart.ChartTitle.Text = "ABC Company (Open-High-Low-Close)";
