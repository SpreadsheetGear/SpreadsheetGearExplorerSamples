...
namespace SharedSamples
{
    ...
    /// boxes, etc.).  See <see cref="SharedEngineSample"/> for samples that only involve the use of the SpreadsheetGear Engine
    /// for .NET product, which don't involve UI to run the sample.
    /// </summary>
    public class SharedWindowsSample : ISample { }
}
