    ...
    public class WindowsSamplesBuilder
    {
        public static Category Build()
        {
            ...
            var categoryWbvSamples = explorerCategory.AddCategory("WorkbookView", "WorkbookView", "WorkbookView properties, methods, designer, explorers, display options, and events.", 10);
            {
                ...
                categoryWbvSamples.AddWindowsSample<CultureInfoSample>("CultureInfo", "Specify a CultureInfo to be used for various regional formatting conventions such as date formats, list separator, decimal separator, currency symbol and more.  This sample creates a workbook with the German 'de-DE' CultureInfo (shown in left WorkbookView), saves the workbook to disk, and re-opens it in the selected CultureInfo (shown in right WorkbookView) to demonstrate changes in locale-sensitive formats.", 30, true);
